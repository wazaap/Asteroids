...
public class PhysicsControl extends RigidBodyControl
    ...
    public void collision(PhysicsCollisionEvent event) {
        if (event.getNodeB() != null && event.getNodeA() != null) {
            ...
            } else if (event.getNodeA().getControl(PlayerControl.class) != null) {
                event.getNodeB().getControl(AsteroidControl.class).hitPlayer();
            } else if (event.getNodeB().getControl(PlayerControl.class) != null) {
                event.getNodeA().getControl(AsteroidControl.class).hitPlayer();
